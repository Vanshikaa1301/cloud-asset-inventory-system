...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex">
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-gray-900 via-gray-800 to-primary-900 items-center justify-center p-12 relative overflow-hidden">
